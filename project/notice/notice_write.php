...
<h1>Notice</h1>
<form method="post" action="notice_ok.php" enctype="multipart/form-data"> <!--enctype="multipart/from-data" : 사진과 text가 같이 들어가게 함-->
  <div class="form-group">
    ...
    <input type="checkbox" name="notice_top" value="1">공지
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="notice_memo" name="notice_memo" rows="5"></textarea>
